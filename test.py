...
parser.add_argument("--comb-th", default=-1, type=float, help="the threshold of combine net")
...
def get_cfg(args):
    ...
    if args.comb_th >= 0:
        cfg.test.combine_threshold = args.comb_th
    if args.result_dir != "":
        cfg.commen.result_dir = args.result_dir
    return cfg
