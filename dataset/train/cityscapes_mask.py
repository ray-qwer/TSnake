...
class CityscapesMaskDataset(Dataset):
    def __init__(self, anno_file, data_root, split, cfg):
        super(CityscapesMaskDataset, self).__init__(anno_file, data_root, split, cfg)
    ...
    def read_original_data(self, anno, path):
        ...
        return img, instance_polys, cls_ids, instance_bbox
