...
parser.add_argument("--num_to_viz", default=0, type=int, help="sample N from image_dir")
...
def run_visualize(cfg):
    ...
    data_loader = make_demo_loader(args.image_dir, cfg=cfg, sample_num=args.num_to_viz)
